...
type PaymentServiceClient interface {
	...
	GetPaymentStatus(ctx context.Context, in *GetPaymentStatusRequest, opts ...grpc.CallOption) (*GetPaymentStatusReponse, error)
...
func (c *paymentServiceClient) GetPaymentStatus(ctx context.Context, in *GetPaymentStatusRequest, opts ...grpc.CallOption) (*GetPaymentStatusReponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPaymentStatusReponse)
...
type PaymentServiceServer interface {
	...
	GetPaymentStatus(context.Context, *GetPaymentStatusRequest) (*GetPaymentStatusReponse, error)
...
func (UnimplementedPaymentServiceServer) GetPaymentStatus(context.Context, *GetPaymentStatusRequest) (*GetPaymentStatusReponse, error) {
